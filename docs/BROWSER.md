...
A deployed Pages site processed three long reports in one batch: 409 pages,
...
against 7 to 13% on synthetic fixtures reflects how much furniture a long
report carries on every page.
